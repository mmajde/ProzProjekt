...
import pl.edu.pw.elka.majde.marek.model.obiekty.statki.StatekBohatera;
...
public class SilnikBohatera
{
    ...
    private final double SZEROKOSC_STATKU = 20.0;
    /** Długość statku bohatera w grze. */
    private final double DLUGOSC_STATKU = 30.0;
    ...
    /**
     * Przesuwa bohatera o daną wartość przesunięcia.
     * 
     * @param przesuniecieBohatera - wartość przesunięcia na osiach x i y.
     */
    public void przesunBohatera(final Przesuniecie przesuniecieBohatera)
    {
        Wspolrzedne noweWspolrzedneBohatera = wspolrzedneBohatera.przesun(
                przesuniecieBohatera.getDx(), przesuniecieBohatera.getDy());
    ...
    public void przesunPociski()
    {
        for (Pocisk pocisk : pociski)
        {
            Wspolrzedne noweWspolrzednePocisku = pocisk.getWspolrzedne().przesun(
                    pocisk.getPrzesunieciePocisku().getDx(), pocisk.getPrzesunieciePocisku().getDy());
    ...
    /**
     * Usuwa statek bohatera.
     */
    public void usunBohatera()
    {
        this.wspolrzedneBohatera = null;
    }
